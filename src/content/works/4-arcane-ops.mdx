...
blurb: Arcane Ops was a limited-run paranormal podcast that ran for seven episodes at the end of 2020. I designed the layout in Adobe XD and built it using WordPress, WooCommerce, and Bootstrap. All logos and graphics were designed in Adobe CC.
slug: arcane-ops
---

Arcane Ops was a limited-run paranormal podcast that ran for seven episodes at the end of 2020. I designed the layout in Adobe XD and built it using WordPress, WooCommerce, and Bootstrap. All logos and graphics were designed in Adobe CC.
