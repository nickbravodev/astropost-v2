...
We spearheaded the rebuild of the Kum & Go site in under four weeks, integrating CMS and API-driven solutions that improved performance, accessibility, and reliability. Building on that success, we led the modernization of the Maverik website, implementing scalable frameworks and establishing enterprise-level coding standards using Astro, React, TypeScript, and modern DevOps workflows.
