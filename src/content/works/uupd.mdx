...
date: 2023-08-26T00:00:00-07
tech: Adobe Illustrator, Photoshop, InDesign
blurb: In 2021, the University of Utah Police Department underwent a leadership transition that marked a turning point for the organization. With a renewed focus on safety, transparency, and community trust, the department needed a fresh identity that would embody its vision and values. We were brought in to lead the full rebranding effort, from research and discovery to design and implementation, creating a cohesive brand system that now defines every touchpoint of public safety across campus.
draft: false
---
...
We oversaw the entire rebrand process. We conducted stakeholder interviews at every level, from command staff to front-line officers, to uncover the department's vision, then translated those insights into a unified design system that could scale across all mediums.
